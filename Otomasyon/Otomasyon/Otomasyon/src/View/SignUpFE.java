...
public class SignUpFE extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SignUpFE frame = new SignUpFE(admin);
	...
	public SignUpFE(Admin admin) {
		...
		lbl_kayitOl.setIcon(new ImageIcon(SignUpFE.class.getResource("/images/logo.png")));
